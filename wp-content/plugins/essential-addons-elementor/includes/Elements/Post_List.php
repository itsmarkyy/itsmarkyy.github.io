    ...
    protected function render()
    {
        ...
        if ($settings['eael_post_list_topbar'] === 'yes') {
            ...
            if ($settings['eael_post_list_terms'] === 'yes') {
                echo '<div class="post-categories" data-template='.json_encode([ 'dir'   => 'pro', 'file_name' => 'default', 'name' => $this->process_directory_name() ], 1).' data-widget="' . $this->get_id() . '" data-class="' . get_class($this) . '" data-args="' . http_build_query($args) . '" data-settings="' . http_build_query($data_settings) . '" data-page="1">
        ...
        echo '<div class="eael-post-list-wrap eael-post-appender eael-post-appender-' . $this->get_id() . '">';
                ...
                if(file_exists($template)){
                    ...
                    if ($query->have_posts()) {
                        $iterator = 0;
                        echo '<div class="eael-post-list-posts-wrap">';
        ...
        if ($settings['eael_post_list_pagination'] === 'yes') {
            ...
            echo '<div class="post-list-pagination" data-template='.json_encode([ 'dir'   => 'pro', 'file_name' => $settings['eael_dynamic_template_Layout'], 'name' => $this->process_directory_name() ], 1).' data-widget="' . $this->get_id() . '" data-class="' . get_class($this) . '" data-args="' . http_build_query($args) . '" data-settings="' . http_build_query($data_settings) . '" data-page="1">
