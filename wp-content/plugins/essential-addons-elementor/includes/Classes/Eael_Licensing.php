...
class Eael_Licensing {
	...
	*/
	...
	public function render_licenses_page() {
		$license_key 	= '8699958a-77f3-4db8-9422-126b0836e1c5';
		$status 		= 'valid';
	...
	public function set_license_key( $license_key ) {
		return update_option( $this->product_slug . '-license-key', '8699958a-77f3-4db8-9422-126b0836e1c5' );
	}
	...
	return ['success' => true, 'expires' => strtotime('+1200 days'), 'error' =>'', 'license' => 'valid'];
	}
